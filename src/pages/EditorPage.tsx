            ...
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2 rounded-md border border-slate-200 bg-white px-3 py-2">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  disabled={!selectedObjectId && activeTool === 'select' && !isShapeSelectorOpen}
                  className="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  View Map / Deselect
                </button>
